			...
			if dt.strftime('%Y-%m-%d') not in vacations:
				...
				if meetingDayNumber == 1:
					...
					if dt.weekday() == 2:	
						...
						print("Period 3," ,dt.strftime("%m-%d-%Y"),",",grade9and10WednesdayPeriod2Start,",",dt.strftime("%m-%d-%Y"),",",grade9and10WednesdayPeriod2End)
						print("Period 2," ,dt.strftime("%m-%d-%Y"),",",grade9and10WednesdayPeriod3Start,",",dt.strftime("%m-%d-%Y"),",",grade9and10WednesdayPeriod3End)
						...
						print("Period 3," ,dt.strftime("%m-%d-%Y"),",",grade9and10normalPeriod2Start,",",dt.strftime("%m-%d-%Y"),",",grade9and10normalPeriod2End)
						print("Period 2," ,dt.strftime("%m-%d-%Y"),",",grade9and10normalPeriod3Start,",",dt.strftime("%m-%d-%Y"),",",grade9and10normalPeriod3End)
