			...
			if dt.strftime('%Y-%m-%d') not in vacations:
				...
				if meetingDayNumber == 1:
					...
					if dt.weekday() == 2:	
						...
						print("Period 3," ,dt.strftime("%m-%d-%Y"),",",grade6to8WednesdayPeriod2Start,",",dt.strftime("%m-%d-%Y"),",",grade6to8WednesdayPeriod2End)
						print("Period 2," ,dt.strftime("%m-%d-%Y"),",",grade6to8WednesdayPeriod3Start,",",dt.strftime("%m-%d-%Y"),",",grade6to8WednesdayPeriod3End)
						...
						print("Period 3," ,dt.strftime("%m-%d-%Y"),",",grade6to8normalPeriod2Start,",",dt.strftime("%m-%d-%Y"),",",grade6to8normalPeriod2End)
						print("Period 2," ,dt.strftime("%m-%d-%Y"),",",grade6to8normalPeriod3Start,",",dt.strftime("%m-%d-%Y"),",",grade6to8normalPeriod3End)
